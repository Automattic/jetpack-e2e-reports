...
aws s3 cp ./docs/data/errors.json "s3://a8c-jetpack-e2e-reports/data/errors.json" --only-show-errors
aws s3 cp ./docs/data/tests.json "s3://a8c-jetpack-e2e-reports/data/tests.json" --only-show-errors
echo "Done!"
